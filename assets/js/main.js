const navMenu = document.getElementById("nav-menu"); // Update the ID to "nav-menu"
...
const enableDarkTheme = () => {
    ...
    // update the selected theme in the localStorage
    localStorage.setItem("theme", "dark-theme");
};

const disableDarkTheme = () => {
    // remove the dark theme class to the body
...
// check if the user previously enable the dark theme
